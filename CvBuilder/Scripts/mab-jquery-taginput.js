...
;(function ( $, window, document, undefined ) {
    ...
    var _createTag = function(tag) { 
        //return '<span class="badge badge-primary" data-tag="' + tag + '">' + tag + ' <span class="removeTag">x</span></span>';
        //return '<span class="badge badge-primary" data-tag="' + tag + '">' + tag + ' <i class="fas fa-times-circle"></i></span>';
